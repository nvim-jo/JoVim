...
function M.format(opts)
  ...
  }, require("jovim.util").opts("nvim-lspconfig").format or {}))
end
...
function M.get_formatters(bufnr)
  ...
  ---@type lsp.Client[]
  local clients = require("jovim.util").get_clients({ bufnr = bufnr })
...
function M.setup(opts)
  ...
  vim.api.nvim_create_autocmd("BufWritePre", {
    group = vim.api.nvim_create_augroup("JoVimFormat", {}),
    callback = function()
      if M.opts.autoformat then
        M.format()
      end
