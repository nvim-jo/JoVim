...
---@class JoRoot
---@field paths string[]
---@field spec JoRootSpec

---@alias JoRootFn fun(buf: number): (string|string[])

---@alias JoRootSpec string|string[]|JoRootFn
...
---@param opts? { buf?: number, spec?: JoRootSpec[], all?: boolean }
function M.detect(opts)
  opts = opts or {}
  opts.spec = opts.spec or type(vim.g.root_spec) == "table" and vim.g.root_spec or M.spec
  opts.buf = (opts.buf == nil or opts.buf == 0) and vim.api.nvim_get_current_buf() or opts.buf

  local ret = {} ---@type JoRoot[]
...
function M.info()
  ...
  lines[#lines + 1] = "```"
  require("jovim.util").info(lines, { title = "JoVim Roots" })
