...
---@param opts? JoFormatter| {filter?: (string|lsp.Client.filter), bufnr?: number}
function M.formatter(opts)
  ...
  return vim.tbl_deep_extend("force", ret, opts) --[[@as JoFormatter]]
end

---@param opts? {filter?: lsp.Client.filter, bufnr?: number}
function M.format(opts)
  vim.lsp.buf.format(
    vim.tbl_deep_extend("force", opts or {}, require("jovim.util").opts("nvim-lspconfig").format or {})
  )
end
