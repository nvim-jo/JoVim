...
return {
  ...
  -- file explorer
  {
    ...
    keys = {
      {
        "<leader>fe",
        function()
          require("Jotree.command").execute({ toggle = true, dir = require("jovim.util").get_root() })
        end,
      ...
      },
      {
        "<leader>fE",
        function()
          require("Jotree.command").execute({ toggle = true, dir = vim.loop.cwd() })
        end,
        desc = "Explorer (cwd)",
      },
    },
    ...
    config = function(_, opts)
      ...
      local events = require("Jotree.events")
      opts.event_handlers = opts.event_handlers or {}
      vim.list_extend(opts.event_handlers, {
        { event = events.FILE_MOVED, handler = on_move },
        { event = events.FILE_RENAMED, handler = on_move },
      })
      require("Jotree").setup(opts)
      vim.api.nvim_create_autocmd("TermClose", {
        pattern = "*lazygit",
        callback = function()
          if package.loaded["Jotree.sources.git_status"] then
            require("Jotree.sources.git_status").refresh()
          end
        end,
      })
    end,
